...
CHARACTERS = {
        ...
        "variants": [
            {
                ...
                "prompt": (
                    "Same person, same face, same identity, same eye color "
                    "— change apparent age to about 26 years old: youthful "
                    "un-weathered skin, slightly longer tousled dark-blonde "
                    "hair, clean-shaven or very light stubble, fresh "
                    "student-climber energy, wearing a plain gray t-shirt. "
                    "Keep facial structure identical. " + PORTRAIT_SUFFIX
                ),
            },
            {
                "file": "age-35.png",
                "prompt": (
                    "Same person, same face, same identity, same eye color "
                    "— change apparent age to about 35 years old: lightly "
                    "sun-weathered skin, short dark-blonde hair, light "
                    "stubble, wearing a plain outdoor softshell. Keep facial "
                    "structure identical. " + PORTRAIT_SUFFIX
                ),
            },
        ],
    ...
    # Alex's mother, Manchester. Base is her ~55 look (the mira-arrives-era
    # visits where she's most featured); age-50 kontexts back for the
    # Manchester era. See CHARACTERS.md.
    "rosa": {
        "base_file": "age-55.png",
        "base_prompt": (
            "A woman in her mid-fifties, fair British complexion with gentle "
            "laugh-lines, softly waved silver-grey shoulder-length hair, warm "
            "hazel eyes, kind approachable expression, wearing a soft "
            "heather-blue cardigan over a blouse, reading glasses pushed up "
            "into her hair. " + PORTRAIT_SUFFIX
        ),
        "variants": [
            {
                "file": "age-50.png",
                "prompt": (
                    "Same person, same face, same identity, same eye color "
                    "— change apparent age to about 50 years old: hair more "
                    "salt-and-pepper than silver and slightly fuller, fewer "
                    "lines, warm energetic expression, wearing a navy "
                    "cardigan. Keep facial structure identical. "
                    + PORTRAIT_SUFFIX
                ),
            },
        ],
